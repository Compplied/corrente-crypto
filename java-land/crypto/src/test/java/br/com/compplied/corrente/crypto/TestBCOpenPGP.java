...
import br.com.compplied.corrente.crypto.utils.PgpHelper;
import br.com.compplied.corrente.crypto.utils.RSAKeyPairGenerator;


public class TestBCOpenPGP {

	private boolean isArmored = false;
	private String id = "agroapi_scicrop_engine";
	private String passwd = "23457%$yHF$%xasf";
	private boolean integrityCheck = true;


	private String pubKeyFile = "/tmp/scicrop_openpgp_rsa1024_public_key.dat";
	private String privKeyFile = "/tmp/scicrop_openpgp_rsa1024_private_key.dat";
